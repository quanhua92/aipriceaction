...
BINDINGS: list[BindingType] = [
    ...
    Binding("2", "switch_tab('workflows')", "Workflows", key_display="2"),
    Binding("3", "switch_tab('tickers-vn')", "Vietnam", key_display="3"),
    Binding("4", "switch_tab('tickers-crypto')", "Crypto", key_display="4"),
    Binding("5", "switch_tab('tickers-global')", "Global", key_display="5"),
