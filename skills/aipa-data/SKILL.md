...
> ```
> If the version is < 0.1.41, upgrade: `uvx aipa-cli@latest fundamentals info ACB` or `pip install --upgrade aipa-cli`.
...
```bash
# All yearly reports for VCB
aipa fundamentals ratios VCB

# Only latest yearly report
