...
-- ── indicators hourly sub-partitions ──
...
-- ── indicators minute sub-partitions ──
...
ALTER TABLE indicators_minute_2023 SET (autovacuum_vacuum_scale_factor = 0.05, autovacuum_analyze_scale_factor = 0.02, autovacuum_vacuum_cost_delay = 10);
ALTER TABLE indicators_minute_2024 SET (autovacuum_vacuum_scale_factor = 0.05, autovacuum_analyze_scale_factor = 0.02, autovacuum_vacuum_cost_delay = 10);
ALTER TABLE indicators_minute_2025 SET (autovacuum_vacuum_scale_factor = 0.05, autovacuum_analyze_scale_factor = 0.02, autovacuum_vacuum_cost_delay = 10);
ALTER TABLE indicators_minute_2026 SET (autovacuum_vacuum_scale_factor = 0.05, autovacuum_analyze_scale_factor = 0.02, autovacuum_vacuum_cost_delay = 10);
